...
<section>
  ...
  <div class="slab-blue">
    <div class="layout-semibreve layout-centered">
      <h2 class="isolate">Ready to Get Started?</h2>
      <p>Code for America Brigades organize through the <strong>4Ps: people, plans, partnerships, and participation</strong>. A group can join the Code for America Brigade network as a Brigade Network Member or an Official Brigade Chapter.</p>
    </div>
  </div>
    ...
    <div class="layout-minim">
      ...
      <ol>
        ...
        <li><strong>Participate</strong></li>
          <ul>
            <li>Share ideas on the Code for America Slack channel</li>
...
<section class="slab-gray">
  <div class="layout-breve">
    <div class="layout-crotchet-staccato">
      ...
      <div style="margin-left: 2em" class="list-ruled">
        <ul>
          ...
          <li>Code with us!<a href="/geeks/civicissues">Check out the new Civic Tech Issue Finder.</a>.</li>
        </ul>
      </div>
    </div>
