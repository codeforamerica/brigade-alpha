...
<section class="layout-semibreve">
    ...
    <p>A group can join the Code for America Brigade network as a <b>Brigade Network Member</b> or an <b>Official Brigade Chapter</b>. </p>
    ...
    <ul>
     ...
     <p>Once you've done that, we'll invite you to join us as an 
      ...
      other Brigades just as a Network Member does, plus recieve fincial and organizing resources.</p>

    <p><b>To learn more about becoming either a Brigade Network Member or an Official Brigade Chapter fill out the above form and we will send you all the details!</b></p>

    <p><b> Joining from outside the United States?</b> Find out more at 
      <a href="http://code-for-all.github.io/codeforall.org/">codeforall.org</a>.</p>
