  ...
  <div class="layout-semibreve">
    ...
    <form action="<?= $base_url ?>/signup" method="POST" accept-charset="UTF-8">
      <ul class="list-form">
        ...
        <p> Joining from outside the United States? Learn more about the international civic-tech network by visiting <a href="http://codeforall.org">codeforall.org</a>.</p>
