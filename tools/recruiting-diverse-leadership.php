...
<section>
  ...
  <div class="layout-semibreve">
    ...
    <h1>Recruiting for Diverse Leadership</h1>
...
<section class="slab-red">
  ...
  <div class="layout-semibreve">
    ...
    <h2>Training Notes and Summary</h2>

    <p>Check out the live notes for the training <a href="http://forum.codeforamerica.org/t/12-march-2015-brigade-training-recruiting-for-diverse-leadership-with-open-oakland/177">here.</a> This training also had a longer series of crowdsourced notes which you can find <a href="https://docs.google.com/a/codeforamerica.org/document/d/1G12KAH4lXrc6dwuq3hK7t2RFoRLfZ1gLYEdmFQCVqVg/edit">here.</a></p>
    
    <p>A few key points from the 47-minute discussion:</p>
    <h4>
      <ol>
        <li>Oakland is <a href="http://priceonomics.com/the-most-and-least-diverse-cities-in-america/">by many measures the most diverse city in the United States</a>, but Open Oakland found that they did not meet that standard for representation. Open Oakland tried to build an organization that could change the city and build trust.</li>
        <li>Open Oakland's leadership picked 17 people in total to discuss the future of the organization. Their recommended process for a leadership change:
          <ol>
            <li>Curate a few folks who are regularly attending and see whether they are interested in being a leader or helping to craft a leadership structure.</li>
        ...
        <li>The big takeaway:
          <li>ELLIE: We were really thoughtful about it and learned a lot.</li>
          <li>EDDIE: It takes time, and you have to want to put the effort into doing this kind of work to reach out and bring in different perspectives. It’s much easier to select people who are just like you.</li>
          <li>SPIKE: Diversity isn’t an idea, it’s an action. It was necessary to do a lot of things to work on this. It was a hard thing to do, but it’s important for us to build a strong base as we get more serious about Open Oakland.</li>
        </li>
      </ol>
    </h4>
