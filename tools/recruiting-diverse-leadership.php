...
<section class="slab-red">
  ...
  <div class="layout-semibreve">
    ...
    <h4>
      <ol>
        <li>Oakland is <a href="http://priceonomics.com/the-most-and-least-diverse-cities-in-america/">by many measures the most diverse city in the United States</a>, but Open Oakland found that they did not represent that standard. Open Oakland tried to build an organization that could build trust and change the city.</li>
